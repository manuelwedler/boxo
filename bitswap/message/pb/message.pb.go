...
const (
	...
	Message_ForwardHave Message_BlockPresenceType = 2
)
...
const (
	...
	Message_Wantlist_Forward Message_Wantlist_WantType = 2
)
...
type Message_BlockPresence struct {
	...
	Addrinfo []*Message_BlockPresence_AddressInfo `protobuf:"bytes,3,rep,name=addrinfo,proto3" json:"addrinfo,omitempty"`
}
...
func (m *Message_BlockPresence) GetAddrinfo() []*Message_BlockPresence_AddressInfo {
	if m != nil {
		return m.Addrinfo
	}
	return nil
...
type Message_BlockPresence_AddressInfo struct {
...
func (m *Message_BlockPresence_AddressInfo) Reset()         { *m = Message_BlockPresence_AddressInfo{} }
func (m *Message_BlockPresence_AddressInfo) String() string { return proto.CompactTextString(m) }
func (*Message_BlockPresence_AddressInfo) ProtoMessage()    {}
func (*Message_BlockPresence_AddressInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_33c57e4bae7b9afd, []int{0, 2, 0}
}
func (m *Message_BlockPresence_AddressInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Message_BlockPresence_AddressInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Message_BlockPresence_AddressInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Message_BlockPresence_AddressInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Message_BlockPresence_AddressInfo.Merge(m, src)
}
func (m *Message_BlockPresence_AddressInfo) XXX_Size() int {
	return m.Size()
}
func (m *Message_BlockPresence_AddressInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_Message_BlockPresence_AddressInfo.DiscardUnknown(m)
}

var xxx_messageInfo_Message_BlockPresence_AddressInfo proto.InternalMessageInfo

func (m *Message_BlockPresence_AddressInfo) GetPeerId() []byte {
	if m != nil {
		return m.PeerId
	}
	return nil
...
func (m *Message_BlockPresence_AddressInfo) GetMultiaddrs() [][]byte {
	if m != nil {
		return m.Multiaddrs
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Message_BlockPresence_AddressInfo)(nil), "bitswap.message.v1.pb.Message.BlockPresence.AddressInfo")
}
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	,
}
...
func (m *Message_BlockPresence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Addrinfo) > 0 {
		for iNdEx := len(m.Addrinfo) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Addrinfo[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Message_BlockPresence_AddressInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Message_BlockPresence_AddressInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_BlockPresence_AddressInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Multiaddrs) > 0 {
		for iNdEx := len(m.Multiaddrs) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintMessage(dAtA, i, uint64(len(m.Multiaddrs[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.PeerId) > 0 {
		...
		i = encodeVarintMessage(dAtA, i, uint64(len(m.PeerId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Message_BlockPresence_AddressInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message_BlockPresence) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Addrinfo = append(m.Addrinfo, &Message_BlockPresence_AddressInfo{})
			if err := m.Addrinfo[len(m.Addrinfo)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Message_BlockPresence_AddressInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
